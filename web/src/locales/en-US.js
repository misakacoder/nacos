...
const I18N_CONF = {
  ...
  NameSpace: {
    ...
    existConfiguration: 'This namespace has configurations and cannot delete!',
    deletePublic: 'Cannot delete public(to retain control)',
  ...
  HistoryRollback: {
    ...
    operation: 'Operation',
    compare: 'Compare',
    configNotExist: 'Config not exist',
